<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-6 mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-4 sm:flex">
                    ...
                    @auth
                        ...
                        @if (auth()->user()->isPeserta())
                            <x-nav-link :href="route('participant.my_classes')" :active="request()->routeIs('participant.my_classes')">
                                Kelas Saya
                            </x-nav-link>
                        @endif
                    @endauth
